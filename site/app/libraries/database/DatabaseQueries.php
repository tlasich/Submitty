...
/////////////////END Office Hours Queue queries//////////////////////////////////
    ...
    public function getPoll($poll_id) {
        ...
        return new PollModel($this->core, $row["poll_id"], $row["name"], $row["question"], $row["question_type"], $responses, $this->getAnswers($poll_id), $row["status"], $this->getUserResponses($row["poll_id"]), $row["release_date"], $row["image_path"], $row["release_histogram"], $row["display_correct"]);
    }
